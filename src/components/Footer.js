...
<footer className="relative bg-blue-950 backdrop-blur-3xl mb-0 bottom-0 backdrop-opacity-0 bg-opacity-100 text-white transition duration-700 
    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://ecanagroup.com/" className="hover:underline">ECANA Group™</a>. All Rights Reserved.
          </span>
